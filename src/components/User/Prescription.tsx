...
import { IPrescription } from "../../interface/interfaceUser";
...
const Prescription = () => {
  ...
  const [prescriptionData, setPrescriptionData] = useState<IPrescription>();
      ...
      >
        <div className="p-6 bg-white relative">
          ...
          <div className="text-center mt-4">
            ...
            <p className="text-gray-600">Hospital or Department Name Here</p>
          </div>
          ...
          <div className="mt-6 flex justify-between">
            <div className="flex flex-col w-1/3">
              <p>
                <span className="font-bold">Name:</span> ffjhjh
              </p>
              <p>
                <span className="font-bold">Age:</span> djfhg
              </p>
              <p>
                <span className="font-bold">Sex:</span> fdjhgfdd
              </p>
              <p>
                <span className="font-bold">Diagnosis:</span>jfdhfjd
              </p>
            </div>
            <div className="flex flex-col w-1/3 items-end">
              {/* <p><span className="font-bold">Date:</span> {new Date(prescription.date).toLocaleDateString()}</p> */}
            </div>
          </div>

          <div className="mt-6">
            <h3 className="font-bold text-lg text-blue-800">Prescription:</h3>
            <div className="mt-2">
              {prescriptionData?.medicines.map((val, index) => (
                <div className="mb-2">
                  <p>
                    <span className="font-bold">Medicine :</span> {val.name}
                  </p>
                  <p>
