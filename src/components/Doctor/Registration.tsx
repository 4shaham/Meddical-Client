...
function Registration() {
  ...
  const {register,handleSubmit,formState:{errors}}=useForm<FormDataFirstPage>()

  const handleFirstFormSubmit=(data:FormDataFirstPage)=>{
        ...
        <div className="w-full h-auto  mx-auto mt-16 border-gray-300 rounded-xl border-solid border-2 my-auto  bg-white">
          ...
          {!pageStatus ? (
            ...
            <form>
              ...
              <div className="h-11 w-full min-w-[200px] md:min-w-[400px]">
                <label className="text-black p-2 md:p-0 text-md md:text-xl">
                  Specialist
                </label>
                <input
                  placeholder=""
              ...
              <div className="h-11 flex w-full min-w-[200px] md:min-w-[400px] mt-10 gap-5">
                <p>Experiences</p>
                <button className="bg-btnColor px-4 text-white rounded-md -mt-2">
                  Add
                </button>
              </div>
              <div className="h-11 flex w-full min-w-[200px] md:min-w-[400px] mt-10 gap-5">
              ...
              <div className="h-11 w-full min-w-[200px] md:min-w-[400px] mt-10">
                <button className="bg-btnColor text-white w-full py-2 rounded-md mb-10">
                  Submit
                </button>
              </div>
              </form>   
